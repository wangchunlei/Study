...
namespace Domas.Web.Mvc.Examples
{
    public class HyphenatedRouteHandler : MvcRouteHandler
    {
        protected override IHttpHandler GetHttpHandler(System.Web.Routing.RequestContext requestContext)
        {
            ...
            {
                requestContext.RouteData.DataTokens["namespaces"] = new[] { "Domas.Web.Mvc.Examples.Controllers.Mobile" };
            }
            else
            {
                requestContext.RouteData.DataTokens["namespaces"] = new[] { "Domas.Web.Mvc.Examples.Controllers" };
            }
