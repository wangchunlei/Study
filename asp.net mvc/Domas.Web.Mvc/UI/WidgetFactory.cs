    ...
    public class WidgetFactory<TModel> : WidgetFactory
    {
        ...
        public virtual DateTimePickerBuilder DateTimePickerFor(Expression<Func<TModel, Nullable<DateTime>>> expression)
        {
            ...
            return DateTimePicker()
                    ...
                    .Min(GetRangeValidationParameter<DateTime>(validators, minimumValidator) ?? UI.DateTimePicker.defaultMinDate)
                    .Max(GetRangeValidationParameter<DateTime>(validators, maximumValidator) ?? UI.DateTimePicker.defaultMaxDate);
        }
        ...
        public virtual DatePickerBuilder DatePickerFor(Expression<Func<TModel, Nullable<DateTime>>> expression)
        {
            ...
            return DatePicker()
                    ...
                    .ModelMetadata(metadata)
                    .Value(metadata.Model as DateTime?)
                    .Min(GetRangeValidationParameter<DateTime>(validators, minimumValidator) ?? UI.DatePicker.defaultMinDate)
                    .Max(GetRangeValidationParameter<DateTime>(validators, maximumValidator) ?? UI.DatePicker.defaultMaxDate);
        }
